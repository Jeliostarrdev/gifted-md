...
global.caption = "*©2025 JELIO STARR 𝐌𝐃 𝐕𝟓*"; // Input Yours custom...(Maintain font for Flow)
...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~If0lSJyT#KDNNS0o5RWPAZ51RqHUbBZ5k2sgMq6SuUVee4JnC9Y0", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
OWNER_NAME: process.env.OWNER_NAME || "JELIO STARR DEV", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "JELIO STARR DEV", // Added // Input Yours custom...
PACK_NAME: process.env.PACK_NAME || "JELIOSTARR-𝐌𝐃💜", // Added // Input Yours custom...
...
BOT_NAME: process.env.BOT_NAME || "JELIOSTARR-𝐌𝐃", // Input Yours custom...(Maintain font for Flow)
